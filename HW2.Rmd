...
```{r, echo=FALSE}
greenbuilding = read.csv('STA380-master/STA380-master/data/greenbuildings.csv')
...
data1 <-"STA380-master/STA380-master/data/ABIA.csv"
ABIA = read.csv(data1)
...
grocery_list <- read.transactions("STA380-master/STA380-master/data/groceries.txt", sep=',')
